...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/templates/form.js");
/******/ })
/************************************************************************/
/******/ ({
 ...
 */
__webpack_require__(/*! ../../scss/templates/form.scss */ "./assets/scss/templates/form.scss");

function collection_add_value(element) {
  var list_selector = element.getAttribute('data-list-selector');
  var list = document.getElementById(list_selector);
  ...
  var widget = element_fragment.firstChild;
...
function collection_delete_value(element) {
  var item_selector = element.getAttribute('data-item-selector');
  var item = document.getElementById(item_selector);
...
/***/ "./assets/scss/templates/form.scss":
/*!*****************************************!*\
  !*** ./assets/scss/templates/form.scss ***!
  \*****************************************/
/*! no static exports found */
